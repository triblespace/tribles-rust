...
//! The design is inspired by Git, but with a focus on content-addressed storage.
...
//! They have no notion of branches or commits, or other stateful constructs.
//! As such they also don't have a notion of time, order or history,
//! massively relaxing the constraints on the storage backend.
//! This makes it possible to use a wide range of storage backends, including those that don't support
...
//! trible commit histories are an append-only chain TribleSet metadata,
